  ...
  <tbody>
  	<c:forEach var="item" items="${products }" varStatus="loop">
	      ...
	      <td>
	      	...
	      	<a onclick="if (confirm('Bạn có chắc chắn muốn xóa?')){window.location.href='${pageContext.request.contextPath }/products/ActionController?action=delete&id=${item.id}';}" href="javascript:void()" class="btn btn-primary">Xóa</a>
	      </td>
	    </tr>
  	</c:forEach>
  </tbody>
